...
const translations: Translations = {
	en: {
		...
		'tournament.enterNickname': 'Enter your nickname:',
		'tournament.nicknamePlaceholder': 'Your nickname',
		'tournament.createBtn': 'Create',
		'tournament.cancelBtn': 'Cancel',
		'tournament.pleaseEnterNickname': 'Please enter your nickname',
		'tournament.nicknameMinLength': 'Nickname must be at least 2 characters',
		'tournament.nicknameTaken': 'Nickname Taken',
		'tournament.nicknameAlreadyTaken': 'This nickname is already taken. Please choose a different one.',
		'tournament.chooseDifferentNickname': 'Choose a different nickname',
		'tournament.joinDescription': 'Please enter your nickname to join the tournament',
		'tournament.creatingAs': 'Creating tournament as:',
		'tournament.failedToJoin': 'Failed to join tournament',
		'tournament.matchFound': 'Match found! Game ID: ',
		'tournament.noMatchAvailable': 'No match available yet.',
		'tournament.bracket.players': 'players',
	...
	pl: {
		...
		'tournament.createTitle': 'Utwórz turniej',
		'tournament.enterNickname': 'Wpisz swój pseudonim:',
		'tournament.nicknamePlaceholder': 'Twój pseudonim',
		'tournament.createBtn': 'Utwórz',
		'tournament.cancelBtn': 'Anuluj',
		'tournament.pleaseEnterNickname': 'Proszę wprowadzić pseudonim',
		'tournament.nicknameMinLength': 'Pseudonim musi mieć co najmniej 2 znaki',
		'tournament.nicknameTaken': 'Pseudonim zajęty',
		'tournament.nicknameAlreadyTaken': 'Ten pseudonim jest już zajęty. Wybierz inny.',
		'tournament.chooseDifferentNickname': 'Wybierz inny pseudonim',
		'tournament.joinDescription': 'Proszę wprowadzić pseudonim, aby dołączyć do turnieju',
		'tournament.creatingAs': 'Tworzenie turnieju jako:',
		'tournament.failedToJoin': 'Nie udało się dołączyć do turnieju',
		'tournament.matchFound': 'Znaleziono mecz! ID gry: ',
		'tournament.noMatchAvailable': 'Brak dostępnych meczów.',
		'tournament.bracket.players': 'graczy',
		'tournament.bracket.title': 'Drabinka turniejowa',
		'tournament.leave': 'Opuść turniej',
		'tournament.playMatch': 'Zagraj mecz',
		'tournament.unknown': 'Nieznany',
		'tournament.tbd': 'TBD',
		'tournament.vs': 'vs',
	...
	es: {
		...
		'tournament.enterNickname': 'Ingresa tu apodo:',
		'tournament.nicknamePlaceholder': 'Tu apodo',
		'tournament.createBtn': 'Crear',
		'tournament.cancelBtn': 'Cancelar',
		'tournament.pleaseEnterNickname': 'Por favor ingresa tu apodo',
		'tournament.nicknameMinLength': 'El apodo debe tener al menos 2 caracteres',
		'tournament.nicknameTaken': 'Apodo ocupado',
		'tournament.nicknameAlreadyTaken': 'Este apodo ya está ocupado. Por favor elige otro.',
		'tournament.chooseDifferentNickname': 'Elige un apodo diferente',
		'tournament.joinDescription': 'Por favor ingresa tu apodo para unirte al torneo',
		'tournament.creatingAs': 'Creando torneo como:',
		'tournament.failedToJoin': 'Error al unirse al torneo',
		'tournament.matchFound': '¡Partido encontrado! ID del juego: ',
		'tournament.noMatchAvailable': 'No hay partidos disponibles aún.',
		'tournament.bracket.players': 'jugadores',
		'tournament.bracket.title': 'Llave del torneo',
		'tournament.leave': 'Abandonar torneo',
		'tournament.playMatch': 'Jugar partido',
		'tournament.unknown': 'Desconocido',
		'tournament.tbd': 'PD',
		'tournament.vs': 'vs',

...
export function TournamentTab() {
    ...
    function renderCreateForm() {
        ...
        formWrapper.classList.add('flex', 'flex-col', 'gap-4', 'items-center', 'justify-center', 'py-8');
        ...
        if (!isLoggedIn) {
            ...
            nicknameWrapper.classList.add('flex', 'flex-col', 'gap-2', 'w-full', 'max-w-md');
    ...
    function renderBracketCanvas(numberOfPlayers: number, playersIn: number) {
        ...
        if (numberOfPlayers === 4) {
            ...
            ctx.beginPath();
            ctx.moveTo(130, 60); ctx.lineTo(180, 110); ctx.stroke();
            ctx.moveTo(130, 180); ctx.lineTo(180, 110); ctx.stroke();
            ctx.moveTo(130, 120); ctx.lineTo(180, 170); ctx.stroke();
            ctx.moveTo(130, 240); ctx.lineTo(180, 170); ctx.stroke();

            ctx.beginPath();
            ctx.moveTo(280, 110); ctx.lineTo(350, 170); ctx.stroke();
            ctx.moveTo(280, 170); ctx.lineTo(350, 170); ctx.stroke();
            ...
            for (let i = 0; i < 4; i++) {
                ctx.beginPath();
                ctx.moveTo(130, 50 + i * 90); ctx.lineTo(180, 70 + i * 90); ctx.stroke();
                ctx.moveTo(130, 95 + i * 90); ctx.lineTo(180, 70 + i * 90); ctx.stroke();
            }
            for (let i = 0; i < 4; i++) {
            ...
            for (let i = 0; i < 2; i++) {
                ctx.beginPath();
                ctx.moveTo(280, 90 + i * 180); ctx.lineTo(350, 130 + i * 180); ctx.stroke();
                ctx.moveTo(280, 180 + i * 180); ctx.lineTo(350, 130 + i * 180); ctx.stroke();
            }
            for (let i = 0; i < 2; i++) {
            ...
            ctx.beginPath();
            ctx.moveTo(450, 150); ctx.lineTo(520, 210); ctx.stroke();
            ctx.moveTo(450, 330); ctx.lineTo(520, 210); ctx.stroke();

            ctx.strokeRect(520, 210, 100, 40);
            ctx.fillText('Winner', 570, 230);
        } else {
            ctx.fillText('Bracket for this number of players is not supported.', canvas.width / 2, canvas.height / 2);
        }
